...
#0.12 to 1.3 array_ops.split and .concat, fix by change order
...
def attention_decoder(decoder_inputs,
    ...
    Raises:
        ValueError: when num_heads is not positive, there are no inputs, shapes
            ...
            from the input.
    """
    # imemory = copy.deepcopy(imemory)
    # ememory = copy.deepcopy(ememory)
...
def embedding_attention_decoder(decoder_inputs,
    ...
    with variable_scope.variable_scope(
        ...
        if use_imemory:
            ...
            # print("1,1,1,1")
            # print(internal_memory.get_shape())
...
def embedding_attention_seq2seq(encoder_inputs,
    ...
    with variable_scope.variable_scope(
        ...
        # Encoder.
        # print(en_cell)
        en_cell = copy.deepcopy(en_cell) #bug3: use deep copy.
        encoder_cell = core_rnn_cell.EmbeddingWrapper(
                en_cell, embedding_classes=num_encoder_symbols,
                embedding_size=embedding_size)
        # print(encoder_cell.state_size)
        encoder_outputs, encoder_state = rnn.static_rnn(
                encoder_cell, encoder_inputs, dtype=dtype)             #bug_group: change embedding_attention_seq2seq to new style
